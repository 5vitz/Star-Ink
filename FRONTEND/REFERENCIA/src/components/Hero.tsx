    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl font-sans font-bold text-white tracking-tighter mb-2">
            Top <span className="text-blue-500">Driver</span>
          </h1>
          <p className="text-blue-400 font-mono text-xs tracking-[0.5em] uppercase mb-12">
            Presença Digital
          </p>
