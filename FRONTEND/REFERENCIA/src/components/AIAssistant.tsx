...
export default function AIAssistant() {
  const [messages, setMessages] = useState<{ role: 'user' | 'assistant'; content: string }[]>([
    { role: 'assistant', content: 'Olá! Sou seu consultor digital Top Driver. Qual seu perfil de uso? Posso te ajudar a escolher o BYD ideal para sua rotina.' }
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        config: {
          systemInstruction: `Você é um consultor especialista em carros elétricos da BYD para a plataforma Top Driver. 
