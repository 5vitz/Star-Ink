...
import Featured3DSection from './components/Featured3DSection';
      ...
      <nav className="fixed top-0 w-full z-50 bg-black/50 backdrop-blur-md border-b border-white/10">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold tracking-tighter">Top Driver</span>
          </div>
      ...
      <footer className="bg-zinc-950 py-20 border-t border-zinc-900">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-2">
              ...
              <p className="text-zinc-500 max-w-sm leading-relaxed">
                Top Driver é uma plataforma independente de consultoria e intermediação digital para veículos BYD. 
          ...
          <div className="pt-8 border-t border-zinc-900 text-center text-zinc-600 text-xs">
            © 2026 Top Driver Digital Showroom. Todos os direitos reservados.
          </div>
        </div>
      </footer>
