...
export default function PhilosophySection() {
  return (
    <section id="philosophy" className="py-24 bg-black border-t border-zinc-900">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          {/* Pillar 1 */}
          <div className="bg-zinc-950 border border-zinc-900 p-8 rounded-3xl flex flex-col items-start hover:border-zinc-800 transition-colors">
