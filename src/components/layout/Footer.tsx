    ...
    <footer className="bg-black py-16 border-t border-zinc-900">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          {/* Col 3: Navigation */}
          <div>
            <h4 className="font-mono text-xs font-bold uppercase tracking-widest text-zinc-400 mb-4">
              Navegação
            </h4>
            <ul className="space-y-3 font-mono text-xs text-zinc-500">
              <li>
                <a href="#catalog" className="hover:text-white transition-colors">
                  Drop 01 (Coleção Mestre)
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 font-mono text-xs text-zinc-500">
              <li>
                <a href="https://www.star-ink.com.br" className="hover:text-white transition-colors">
                  www.star-ink.com.br
                </a>
              </li>
              <li>
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-zinc-900/60 flex flex-col sm:flex-row items-center justify-between gap-4 text-zinc-600 font-mono text-[11px]">
